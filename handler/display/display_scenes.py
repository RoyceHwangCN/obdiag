...
class DisplaySceneHandler(SafeStdio):
    ...
    def __init_report_path(self):
        try:
            self.report_path = os.path.join(self.display_pack_dir, "obdiag_display_pack_{0}".format(TimeUtils.timestamp_to_filename_time(self.display_timestamp), self.stdio))
    ...
    def init_option(self):
        ...
        if store_dir_option:
            ...
            self.display_pack_dir = os.path.abspath(store_dir_option)
        if scene_option:
